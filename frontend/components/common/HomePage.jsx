...
const RetroTradePage = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-amber-950">
      {/* Navigation - Background changed to light beige */}
  ...
  onMouseEnter={() => LoginPage.preload()}  // Preload when hovered
>
  <User size={18} className="mr-2" /> Log In
      ...
      {/* Mobile Menu */}
      {isMenuOpen && (
        <div className="fixed inset-0 bg-amber-50 z-20 pt-16 px-6 lg:hidden">
      ...
      <section className="pt-32 pb-16 px-6 md:px-16 lg:px-24 max-w-screen-xl mx-auto">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div className={`transition-opacity duration-1000 ${fadeIn ? 'opacity-100' : 'opacity-0'}`}>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight bg-gradient-to-r from-amber-700 via-amber-600 to-amber-500 text-transparent bg-clip-text mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button className="bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white py-6 px-8 rounded-lg text-lg"  onClick={() => navigate("/auth/register")}>
                Start Shopping
              </Button>
              <Button variant="outline" className="border-amber-400 text-amber-600 hover:bg-amber-50 py-6 px-8 rounded-lg text-lg" onClick={() => navigate("/auth/register")}>
                Sell an Item
              </Button>
            </div>
          </div>
          <div className={`relative transition-all duration-1000 delay-300 transform ${fadeIn ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            ...
            <div className="absolute -bottom-6 -right-6 bg-gradient-to-br from-amber-500 to-amber-600 p-4 rounded-lg shadow-lg z-10">
              <div className="text-xl font-bold text-white">30K+</div>
              <div className="text-sm text-white">Active Users</div>
            </div>
            <div className="absolute -top-6 -left-6 bg-gradient-to-br from-amber-600 to-amber-500 p-4 rounded-lg shadow-lg z-10">
      ...
      {/* Search Section */}
      <section className="py-12 px-6 md:px-16 bg-amber-100 bg-opacity-60">
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            <Input 
              type="text" 
              placeholder="Search for vintage cameras, furniture, clothing..."
              className="w-full py-6 pl-12 pr-4 rounded-full bg-white text-amber-900 text-lg focus:outline-none focus:ring-2 focus:ring-amber-400 shadow-md"
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
            />
            <Search className="absolute left-4 top-1/2 transform -translate-y-1/2 text-amber-500" size={20} />
            <Button className="absolute right-2 top-1/2 transform -translate-y-1/2 rounded-full px-6 py-5 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white">
              Search
            </Button>
          </div>
          <div className="flex flex-wrap gap-3 mt-4 justify-center">
            {categories.map((category, index) => (
              <Badge 
                ...
                className={`px-4 py-2 text-sm rounded-full cursor-pointer shadow-sm transition-all duration-300 
      ...
      <div className="flex justify-between items-center mb-8">
        <h2 className="text-3xl font-bold text-amber-800">Featured Items</h2>
      ...
      {noProductsFound ? (
        <div className="text-center py-16">
          ...
          <p className="text-amber-600 mb-6">Try adjusting your search or filters to find what you're looking for.</p>
          <Button
            variant="outline"
        ...
        <div className="relative">
          ...
          <div 
            className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 transition-all duration-300 ease-in-out transform
              ...
              getCurrentItems().map((item, index) => (
                <Card key={item.id || index} className="bg-white border-amber-100 shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden hover:-translate-y-1 group">
                  <div className="relative">
                    ...
                    {/* <Button variant="ghost" size="icon" className="absolute top-2 left-2 text-amber-600 hover:text-pink-500 bg-white bg-opacity-80 rounded-full p-1.5 shadow-sm">
                      <Heart size={16} />
                    </Button> */}
                  </div>
                  <CardContent className="p-4">
                    {/* Title with text truncation - limits to one or two lines */}
                    ...
                    <Button className="w-full mt-2 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white">
                      View Details
                    </Button>
                  </CardContent>
                </Card>
      ...
      {displayProducts.length > 12 && (
        <div className="mt-8 text-center">
          <Button 
            className="bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white py-3 px-8 rounded-lg text-lg"
            onClick={() => navigate("/auth/login")}
          >
      ...
      {/* How It Works */}
      <section className="py-16 px-6 md:px-16 bg-gradient-to-r from-amber-50 to-white">
        <div className="max-w-screen-xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-amber-800 mb-12">How RetroTrade Works</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center text-center bg-white rounded-lg p-6 border border-amber-100 shadow-md">
              <div className="bg-gradient-to-br from-amber-500 to-amber-600 w-16 h-16 rounded-full flex items-center justify-center mb-4 text-white text-2xl font-bold">1</div>
              <h3 className="text-xl font-semibold mb-3 text-amber-800">Create a Listing</h3>
              <p className="text-amber-600">Snap photos, write a description, and set your price for your pre-loved items.</p>
            </div>
            
            <div className="flex flex-col items-center text-center bg-white rounded-lg p-6 border border-amber-100 shadow-md relative">
              <div className="absolute -left-4 top-1/2 hidden md:block">
                <ArrowRight size={24} className="text-amber-400" />
              </div>
              <div className="bg-gradient-to-br from-amber-500 to-amber-600 w-16 h-16 rounded-full flex items-center justify-center mb-4 text-white text-2xl font-bold">2</div>
              <h3 className="text-xl font-semibold mb-3 text-amber-800">Connect & Negotiate</h3>
            ...
            <div className="flex flex-col items-center text-center bg-white rounded-lg p-6 border border-amber-100 shadow-md relative">
              ...
              <div className="bg-gradient-to-br from-amber-500 to-amber-600 w-16 h-16 rounded-full flex items-center justify-center mb-4 text-white text-2xl font-bold">3</div>
              <h3 className="text-xl font-semibold mb-3 text-amber-800">Secure Transaction</h3>
      ...
      {/* Benefits Section */}
      <section className="py-16 px-6 md:px-16 max-w-screen-xl mx-auto">
        <h2 className="text-3xl font-bold text-center text-amber-800 mb-12">Why Choose RetroTrade?</h2>
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {benefits.map((benefit, index) => (
            <div 
              key={index} 
              className="p-6 rounded-lg border border-amber-100 bg-white hover:bg-amber-50 transition-all duration-300 shadow-md"
            >
              <div className="text-4xl mb-4">{benefit.icon}</div>
              <h3 className="text-xl font-semibold mb-2 text-amber-800">{benefit.title}</h3>
      ...
      {/* Categories Section */}
      <section className="py-16 px-6 md:px-16 bg-gradient-to-r from-amber-100 via-white to-amber-50">
        <div className="max-w-screen-xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {categories.map((category, index) => (
              <div 
                key={index} 
                className="bg-white rounded-xl p-6 flex flex-col items-center text-center border border-amber-100 hover:border-amber-300 transition-all duration-300 cursor-pointer hover:bg-amber-50 group shadow-sm"
              >
      ...
      <section className="py-16 px-6 md:px-16 max-w-screen-xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {testimonials.map((testimonial, index) => (
            <div 
              key={index} 
              className="bg-white p-6 rounded-lg border border-amber-100 shadow-md"
            >
              <div className="mb-4 text-amber-600">
                <span className="text-yellow-500 text-lg">★★★★★</span>
              </div>
              <p className="text-amber-600 mb-4">"{testimonial.comment}"</p>
              <div className="flex items-center">
      ...
      {/* CTA Section */}
      <section className="py-16 px-6 md:px-16 bg-gradient-to-r from-amber-500 to-amber-600">
        <div className="max-w-screen-lg mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button className="bg-white hover:bg-amber-50 text-amber-600 py-6 px-8 rounded-lg text-lg">
              Sign Up Now
            </Button>
            <Button variant="outline" className="border-white text-white hover:bg-amber-400 hover:bg-opacity-20 py-6 px-8 rounded-lg text-lg">
              Learn More
            </Button>
          </div>
        </div>
      ...
      {/* Footer */}
      <footer className="bg-white py-12 px-6 md:px-16 border-t border-amber-100">
        <div className="max-w-screen-xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            <div>
              <h3 className="text-xl font-bold mb-4 text-amber-800">RetroTrade</h3>
              <p className="text-amber-600 mb-4">Buy and sell pre-loved items in a secure, sustainable marketplace.</p>
            ...
            <div>
              <h3 className="text-lg font-semibold mb-4 text-amber-800">Quick Links</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold mb-4 text-amber-800">Help & Support</h3>
              <ul className="space-y-2 text-amber-600">
            ...
            <div>
              <h3 className="text-lg font-semibold mb-4 text-amber-800">Stay Updated</h3>
              <p className="text-amber-600 mb-4">Subscribe to receive updates on new items and promotions.</p>
              <div className="flex">
                <Input 
                  type="email" 
              ...
              <p className="text-xs text-amber-400 mt-2">We respect your privacy and won't share your information.</p>
            </div>
          </div>
          
          <div className="pt-8 mt-8 border-t border-amber-100 text-center text-amber-500 text-sm">
